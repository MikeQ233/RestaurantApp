...
public class Config {
    ...
    private static String logFolder = extras + "log";
    ...
    private static String[] configValues = {finishedOrders, finishedItems, menuItems, beverage, food, items, orders, stock, extras, bills, lockFile, logFolder,initOrderNumber, initItemNumber};
...
//        }
    ...
    private static void setNewConfigValue(HashMap<String, String> values){
        ...
        logFolder = values.get(properties[11]);
        configValues[11] = values.get(properties[11]);
        initOrderNumber = values.get(properties[12]);
        configValues[12] = values.get(properties[12]);
        initItemNumber = values.get(properties[13]);
        configValues[13] = values.get(properties[13]);
    }
...
//            System.err.println("Error, cannot create " + fileName + " file");
    ...
    /**
     * Returns the oldClasses.Food path.
     * @return the oldClasses.Food path.
     */
     ...
     */
    public static String getBillsPath(){
        return bills;
    }
